...
{
    /// <summary>
    /// ResourceKey to access DevDumps Brand Colours.
    /// 
    ...
    /// </summary>
    public class DevDumpsColourKey : EnumIdResourceKeyBase<DevDumpsColourIdEnum>
    {
        /// <summary>
        /// Constructor for usage in markup extension.
        /// </summary>
        /// <param name="id"></param>
        public DevDumpsColourKey(DevDumpsColourIdEnum id)
            : base(id)
        {
        }
